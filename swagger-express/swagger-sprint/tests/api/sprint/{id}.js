...
/**
 * Test for /api/sprint/{id}
 */
Test('/api/sprint/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test sprint_getById get operation', function (t) {
            Mockgen().requests({
                path: '/api/sprint/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/sprint/{id}']['get']['responses']['200']['schema']);
